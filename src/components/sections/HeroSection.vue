...
onMounted(() => {
  ...
  .to(".hero__subtitle", {
    ...
    x: 0, // 可以加一點位移
    duration: 0.8,
  }, "-=0.6") // "-=0.6" 代表在上一個動畫結束前 0.6 秒就開始，讓動作更連貫
  .to(".hero__actions", {
    opacity: 1,
    y: 0,
    duration: 0.8,
...
.hero__title { font-size: 4rem; margin-bottom: 1rem; }
.hero__subtitle { font-size: 1.5rem; opacity: 0; } /* 先隱藏，交給 GSAP 控制 */
.hero__actions { margin-top: 2rem; opacity: 0; display: flex; gap: 40px;}
